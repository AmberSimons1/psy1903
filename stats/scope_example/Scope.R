#### Scope setup ---------------------------------------------------------------
dir.create("~/Documents/psy1903/stats/scope_example")
setwd("~/Documents/psy1903/stats/scope_example")
...
my_function(50) # Passes the value directly via the argument, e.g., `x <- 5` is implicitly coded by placing the 5 in the x position of the function argument, and each call of my_function(x) will produce an updated output of x * 2 as expected
print(x)
